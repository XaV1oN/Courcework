...
void glMyNormal9d(double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3)
{
	...
	/*glBegin(GL_LINES);
	glVertex3d(x1, y1, z1);
	glVertex3d(x1 + n[0], y1 + n[1], z1 + n[2]);
	glEnd();*/
}
...
void Render(OpenGL *ogl)
{
	...
	//
	glMyNormal9d(4, 8, 3, 4, 8, 4, 4, 2, 3);
	...
	//
	//
	glMyNormal9d(2, 9, 3, 2, 9, 4, 4, 8, 3);
	glColor3d(0.3, 0.9, 0.9);
	glVertex3d(4, 8, 4);
	glVertex3d(2, 9, 4);
	glVertex3d(2, 9, 3);
	glVertex3d(4, 8, 3);
	...
	//
	glMyNormal9d(2, 6, 3, 2, 6, 4, 2, 9, 3);
	glColor3d(0.3, 0.4, 0.1);
	glVertex3d(2, 9, 4);
	glVertex3d(2, 6, 4);
	glVertex3d(2, 6, 3);
	glVertex3d(2, 9, 3);
	...
	//
	glMyNormal9d(3, 4, 3, 3, 4, 4, 2, 6, 3);
	...
	//
	glMyNormal9d(2, 2, 3, 2, 2, 4, 3, 4, 3);
	...
	//
	glMyNormal9d(4, 2, 3, 4, 2, 4, 2, 2, 3);
